		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				while ($crow = $cat_qry->fetch_assoc()):
					...
					if ($sub_qry->num_rows <= 0):
						...
						<li class="nav-item">
							...
							<a class="nav-link" aria-current="page" href="./?p=products&c=<?php echo md5($crow['id']) ?>"><?php echo $crow['category'] ?></a>
						</li>

					<?php else: ?>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" id="navbarDropdown<?php echo $crow['id'] ?>" href="#"
								role="button" data-toggle="dropdown" aria-expanded="false"><?php echo $crow['category'] ?></a></a>
			...
			<div class="d-flex align-items-center">
				...
				<?php else: ?>
					...
					<a href="./?p=my_account" class="text-dark  nav-link">
						<b> Xin chào,
							<?php echo $_settings->userdata('firstname') ?>!
						</b>
					</a>
					<a href="logout.php" class="text-dark  nav-link">
