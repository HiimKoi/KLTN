...
$sanitized_id = filterHashMd5($id, true);

$product = $conn->query("SELECT * FROM `products`  where md5(id) = '$sanitized_id' ");
if ($product->num_rows > 0) {
    foreach ($product->fetch_assoc() as $k => $v) {
        $$k = stripslashes($v);
    }
    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                    <span><small><b>Giá: </b></small><span
                            id="price"><?php echo number_format($inv[0]['price']) ?></span>/<span>
                            <br>
                            <span><small><b>Sản phảm có sẵn:</b> <span
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <?php
            $products = $conn->query("SELECT * FROM `products` where status = 1 and (category_id = '{$category_id}' or sub_category_id = '{$sub_category_id}') and id !='{$sanitized_id}' order by rand() limit 4 ");
