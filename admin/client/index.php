        ...
        <div id="printable">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    // echo "<br>";
                    $qry = $conn->query("SELECT * FROM `client_login` where date(date_login) between '{$date_start}' and '{$date_end}' order by unix_timestamp(date_login) desc ");
...
$(function() {
    $('#filter-form').submit(function(e) {
        e.preventDefault()
        location.href = "./?page=sales&date_start=" + $('[name="date_start"]').val() + "&date_end=" + $(
            '[name="date_end"]').val()
    })
