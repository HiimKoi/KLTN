...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=inventory/manage_inventory" class="btn btn-flat btn-primary"><span
					class="fas fa-plus"></span> Tạo</a>
		</div>
	</div>
	<div class="card-body">
					...
					<tbody>
						...
						while ($row = $qry->fetch_assoc()):
							...
							<tr>
								...
								<td>
									<p class="m-0"><small><b>Tên:</b>
											<?php echo $row['product'] ?>
										</small></p>
									<p class="m-0 truncate"><b>Nguyên liệu:</b>
										<?php echo $row['author'] ?>
									</p>
								</td>
								<td class="text-right">
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item"
											href="?page=inventory/manage_inventory&id=<?php echo $row['id'] ?>"><span
...
<script>
	$(document).ready(function () {
		$('.delete_data').click(function () {
			_conf("Bạn có chắc chắn xóa sản phẩm này vĩnh viễn không?", "delete_inventory", [$(this).attr(
				'data-id')])
		})
		$('table').dataTable({
			language: {
